...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Você ainda tem caminhos: (1) tentar a próxima edição do PROUNI; (2) entrar pelo SISU em universidade pública; (3) usar o FIES para financiar a faculdade; (4) usar o Bolsa Click para conseguir desconto de até 78% direto com as faculdades parceiras, sem critério de renda.',
  },
]
    ...
    >
      ...
      <ul>
        ...
        <li>
          ...
          (até 78% na mensalidade). <Link href="/bolsas-de-estudo">Confira as ofertas
          disponíveis</Link>.
        </li>
      </ul>
      <p>
