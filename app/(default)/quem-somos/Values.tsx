...
export default function Values() {
  ...
  const values = [
    {
      icon: <GraduationCap className="h-8 w-8 text-[#00361f]" />,
    ...
    {
      icon: <Award className="h-8 w-8 text-[#00361f]" />,
      title: 'Excelência',
    ...
    {
      icon: <Users className="h-8 w-8 text-[#00361f]" />,
      title: 'Comunidade',
    ...
    {
      icon: <Heart className="h-8 w-8 text-[#00361f]" />,
          ...
          {values.map((value, index) => (
            ...
            >
              <div className="mb-6 flex justify-center">
                <div className="w-16 h-16 rounded-full bg-[#8ee48a]/30 flex items-center justify-center">
                  {value.icon}
                </div>
              </div>
              <h3 className="text-xl font-bold text-[#00361f] mb-4">{value.title}</h3>
