...
export const metadata: Metadata = {
  ...
  description:
    'Simule sua bolsa de estudo em 1 minuto: informe curso, cidade, nota do ENEM e renda e descubra se você se qualifica pra ProUni, FIES ou SISU — além de bolsas próprias de até 78% sem nota de corte. Grátis e sem CPF.',
  keywords: [
    'simulador de bolsa',
  ...
  openGraph: {
    ...
    description:
      'Calcule sua bolsa em 1 minuto: ProUni, FIES, SISU e bolsas próprias de até 78% de desconto, sem nota de corte.',
    url: pageUrl,
  ...
  twitter: {
    ...
    description: '1 minuto pra descobrir sua bolsa: ProUni, FIES e descontos de até 78%.',
  },
}
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Pra ProUni e FIES, a regra é média de pelo menos 450 pontos nas cinco áreas do ENEM e nota de redação acima de zero. Para bolsas próprias de faculdades parceiras não há nota de corte — o desconto depende só da oferta ativa e pode chegar a 78%.',
  },
  {
    question: 'Preciso ter feito o ENEM pra usar o simulador?',
    answer:
      'Não. Se você não fez o ENEM, o simulador te direciona direto pras bolsas próprias das faculdades parceiras, que não exigem nota de corte nem comprovação de renda. Muitas chegam a 78% de desconto na mensalidade, principalmente no EAD.',
  },
  {
...
const webAppSchema = {
  ...
  url: pageUrl,
  description:
    'Simulador gratuito de bolsa de estudo. Estima elegibilidade a ProUni, FIES e SISU com base em nota do ENEM e renda, e mostra ofertas reais de bolsa própria de até 78% de desconto.',
      ...
      <header className="bg-paper border-b border-hairline py-8 md:py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-base md:text-xl text-ink-700 max-w-2xl mb-5 md:mb-6 leading-relaxed">
            ...
            próprias de faculdades parceiras com <strong>até 78% de desconto</strong>,
            sem nota de corte.
          </p>
        ...
        <div className="container mx-auto px-4 max-w-3xl prose prose-neutral prose-headings:font-display">
          ...
          <ul>
            ...
            <li>
              ...
              que chegam a até 78% e não exigem nota de corte nem comprovação de
