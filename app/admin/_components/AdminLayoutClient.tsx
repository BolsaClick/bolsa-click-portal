...
import type { BrandId } from '@/app/lib/admin/brands'
...
function AdminLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      {/* Faixa de 3px com a cor da marca ativa — sinal periférico, em toda tela do painel,
          de qual marca está sendo administrada (ver app/lib/admin/brands.ts). */}
      <div className="h-[3px] w-full" style={{ backgroundColor: activeBrand.color }} />
      ...
      <aside
        className={`
        fixed top-[3px] left-0 z-50 h-[calc(100%-3px)] w-64 bg-gradient-to-b from-bolsa-primary to-blue-800 text-white transform transition-transform duration-200
...
export default function AdminLayoutClient({
  ...
  return (
    <AdminProvider>
      <BrandProvider initialBrand={initialBrand} statuses={statuses}>
