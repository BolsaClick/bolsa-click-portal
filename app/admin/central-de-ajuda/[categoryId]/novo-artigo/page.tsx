...
export default function NewArticlePage({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const token = await firebaseUser.getIdToken()
      const response = await fetch('/api/admin/help-center/articles', {
        method: 'POST',
        headers: {
    ...
    <div>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500">Categoria: {category.title}</p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                URL: /central-de-ajuda/{category.slug}/{slug || 'slug-do-artigo'}
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder={title || 'Título para SEO (deixe vazio para usar o título)'}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-bolsa-primary focus:border-transparent"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={description || 'Descrição para SEO (deixe vazio para usar a descrição)'}
                rows={2}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-bolsa-primary focus:border-transparent resize-none"
              />
            </div>
