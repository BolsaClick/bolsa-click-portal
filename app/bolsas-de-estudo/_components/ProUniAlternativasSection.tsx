...
const ALTERNATIVAS: Alternativa[] = [
  {
    ...
    descricao:
      `Faculdades particulares parceiras negociam bolsas próprias de até ${DISCOUNT_CEILING_PCT}% diretamente pelo Bolsa Click, sem nota de corte, sem critério de renda e com matrícula aberta o ano inteiro. O ingresso é via vestibular agendado online — resultado em horas — ou aproveitamento do histórico do ensino médio.`,
