...
export const metadata: Metadata = {
  ...
  title: 'Bolsas de Estudo até 78%: Compare Faculdades e Preços',
  description: `Compare bolsas de estudo de até 78% em graduação, pós e tecnólogo. ${BRAZILIAN_CITIES.length} cidades, faculdades reconhecidas pelo MEC. ProUni, FIES e bolsa própria.`,
  keywords: [
    'bolsa de estudo',
    'bolsas de estudo',
  ...
  openGraph: {
    ...
    description: `Encontre cursos com até 78% de desconto em ${BRAZILIAN_CITIES.length} cidades.`,
...
const PASSOS = [
  ...
  },
  {
    ...
    detalhe:
      'O teto atual do catálogo é 78%, em EAD e presencial (o percentual varia por curso, unidade e modalidade). Pós-graduação e cursos profissionalizantes também têm bolsas. Filtre por cidade, modalidade e área de interesse.',
  },
  {
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Serve sim, e é onde os descontos costumam ser maiores. Cursos EAD em faculdades parceiras do Bolsa Click têm bolsas próprias de até 78% da mensalidade, e o ProUni também cobre cursos a distância desde 2017 — com os mesmos critérios de nota e renda do presencial. A vantagem econômica do EAD é dupla: a mensalidade base já é mais baixa que a do presencial (o custo operacional por aluno é menor) e o percentual de bolsa aplicado costuma ser maior, então o valor final fica na faixa de R$ 99 a R$ 250 por mês na maioria dos cursos do catálogo. O diploma EAD tem a mesma validade legal do presencial quando o curso é reconhecido pelo MEC, e cursos com componente prático (como os da área da saúde) usam polos presenciais pra laboratórios e estágios obrigatórios.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Com bolsa integral (ProUni 100% ou bolsa própria de 100%), a economia é o valor total do curso — em torno de R$ 60 mil a R$ 200 mil dependendo da graduação. Com bolsa de 50% a 78%, a economia varia de R$ 30 mil a R$ 150 mil. EAD com bolsa de 78% chega a custar R$ 80 a R$ 200 mensais, dependendo do curso.',
  },
  {
  ...
  return (
    <>
      ...
      <header className="bg-paper border-b border-hairline py-12 md:py-20">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <p className="text-lg md:text-xl text-ink-700 max-w-3xl">
            Encontre cursos de graduação e pós com até <strong>78% de desconto</strong> em
          ...
          <div className="mt-8 flex flex-wrap gap-6 font-mono text-[12px] tracking-[0.16em] uppercase text-ink-500">
            ...
            <span><strong className="text-ink-900 num-tabular">até 78%</strong> de desconto</span>
          </div>
        </div>
      </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-hairline border border-hairline">
            ...
            <div className="bg-paper p-6 md:p-8">
              ...
              <p className="text-ink-700 text-[15px] leading-relaxed mb-5">
                ...
                bolsa própria de faculdade parceira chega a 78% no EAD, sem nota de corte, com
            ...
            <table className="w-full border-collapse text-sm">
              ...
              <tbody>
                ...
                <tr className="border-b border-hairline">
                  ...
                  <td className="py-3 px-3 text-ink-900 font-medium num-tabular">78%</td>
      ...
      <section id="onde-conseguir" className="bg-white py-12 md:py-16 border-b border-hairline" data-speakable="onde-conseguir">
        <div className="container mx-auto px-4 max-w-3xl prose prose-neutral">
          ...
          <p className="text-ink-700 leading-relaxed">
            ...
            parceiras pelo Bolsa Click, onde a bolsa própria chega a <strong>78% sem nota de
      ...
      <section id="bolsas-por-curso" className="bg-paper py-12 md:py-16 border-b border-hairline">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <p className="text-ink-700 leading-relaxed mb-8 max-w-3xl text-[15px]">
            ...
            Descontos de até 78%, inscrição grátis e resultado em até 48h.
          </p>
      ...
      <section id="bolsa-enem" className="bg-white py-12 md:py-16 border-b border-hairline">
        <div className="container mx-auto px-4 max-w-3xl prose prose-neutral">
          ...
          <p className="text-ink-700 leading-relaxed">
            ...
            o ingresso (sem fazer vestibular) e ainda assim conseguir bolsa de 25% a 78%. Pra quem
      ...
      <section id="bolsa-ead" className="bg-paper py-12 md:py-16 border-b border-hairline">
        <div className="container mx-auto px-4 max-w-3xl prose prose-neutral">
          <h2 className="font-display text-2xl md:text-3xl font-semibold text-ink-900 mb-4">
            Bolsas em faculdades EAD — até 78% de desconto
          </h2>
          <p className="text-ink-700 leading-relaxed">
            Cursos a distância (EAD) são onde as bolsas próprias chegam aos maiores percentuais —
            até <strong>78% de desconto</strong> em faculdades parceiras como Anhanguera, Unopar,
