...
const PROGRAMAS = [
  ...
  },
  {
    ...
    desconto: `Até ${DISCOUNT_CEILING_PCT}%`,
...
export const metadata: Metadata = {
  ...
  description:
    `Guia completo de como conseguir bolsa de estudo em faculdade particular: ProUni, FIES, Bolsa Click e mais. Sem ENEM, sem ProUni, sem complicação — descontos de até ${DISCOUNT_CEILING_PCT}%.`,
  keywords: [
  ...
  openGraph: {
    ...
    description:
      `Guia completo: ProUni, FIES, Bolsa Click e mais. Descontos de até ${DISCOUNT_CEILING_PCT}%, sem ENEM, sem ProUni.`,
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="bg-paper border border-hairline rounded-lg p-6 md:p-8">
            ...
            <p className="text-ink-900 leading-relaxed text-lg">
              ...
              Click e marketplaces similares (sem ENEM, até {DISCOUNT_CEILING_PCT}%), bolsas filantrópicas de
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-6 text-ink-800 leading-relaxed">
            ...
            <div className="border-l-2 border-bolsa-secondary pl-5">
              ...
              <p>
                <strong>Bolsa Click</strong> é o caminho. Desconto de até {DISCOUNT_CEILING_PCT}% em faculdades
            ...
            <div className="border-l-2 border-bolsa-secondary pl-5">
              ...
              <p>
                Combine Bolsa Click (até {DISCOUNT_CEILING_PCT}% off) com cursos em modalidade EAD reconhecida pelo
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <ul className="space-y-5">
            {[
              ...
              {
                ok: false,
                claim: `Bolsa de até ${DISCOUNT_CEILING_PCT}% é golpe.`,
                truth:
