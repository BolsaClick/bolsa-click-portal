...
const central = theme === 'anhanguera' ? 'https://ajuda.anhangueracursos.com.br/pt-br/' : 'https://ajuda.bolsaclick.com.br/pt-br/'
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center items-center gap-8 mb-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600">Ambiente Protegido</span>
          </div>
          <div className="flex items-center gap-2">
            <HelpCircle className="w-5 h-5 text-gray-600" />
            <span className="text-sm text-gray-600">Suporte 24h</span>
          </div>
        </div>
