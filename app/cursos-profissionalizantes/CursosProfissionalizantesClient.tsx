...
const OFFERS: Offer[] = [
  {
    course: 'Administração e Gestão de Negócios',
    ...
    originalPrice: 380,
    discountPct: 74,
    href: '/curso/resultado?c=administracao&nivel=CURSO_PROFISSIONALIZANTE&modalidade=EAD',
  },
  {
    course: 'Auxiliar de Recursos Humanos',
    institution: 'Unopar',
    ...
    originalPrice: 290,
    discountPct: 73,
    href: '/curso/resultado?c=auxiliar-rh&nivel=CURSO_PROFISSIONALIZANTE&modalidade=EAD',
  },
  {
    ...
    originalPrice: 480,
    discountPct: 73,
    href: '/curso/resultado?c=eletricista-industrial&nivel=CURSO_PROFISSIONALIZANTE',
  },
  {
    course: 'Atendimento e Vendas',
    institution: 'Ampli',
    ...
    originalPrice: 220,
    discountPct: 69,
    href: '/curso/resultado?c=atendimento-vendas&nivel=CURSO_PROFISSIONALIZANTE&modalidade=EAD',
  },
  {
    course: 'Logística e Almoxarifado',
    institution: 'Anhanguera',
    logo: '/assets/logo-anhanguera-bolsa-click.svg',
    modality: 'EAD',
    city: 'Recife',
    ...
    originalPrice: 320,
    discountPct: 72,
    href: '/curso/resultado?c=logistica&nivel=CURSO_PROFISSIONALIZANTE&modalidade=EAD',
  },
  {
    ...
    originalPrice: 350,
    discountPct: 72,
    href: '/curso/resultado?c=cuidador-idosos&nivel=CURSO_PROFISSIONALIZANTE&modalidade=PRESENCIAL',
  },
]
