...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Mensalidades de faculdade EAD com bolsa pelo Bolsa Click começam a partir de R$ 99/mês em parceiras como Anhanguera, Unopar e Pitágoras. Descontos chegam a 78% sobre o valor cheio. Cursos tecnólogos (2-2,5 anos) tendem a ser mais baratos que bacharelados (4-5 anos).',
  },
  {
...
const jsonLdSchemas = [
  {
    ...
    description:
      'Faculdades EAD parceiras com bolsa de até 78%, das maiores redes de ensino do país. Graduação a distância reconhecida pelo MEC. Inscrição grátis, sem ENEM.',
...
export const metadata: Metadata = {
  title: 'Faculdade EAD Mais Barata: Bolsa de até 78%',
  description:
    'A faculdade EAD mais barata começa a partir de R$ 99/mês com bolsa de até 78% pelo Bolsa Click — em graduações reconhecidas pelo MEC como Administração, Pedagogia e ADS. Inscrição grátis, sem ENEM.',
  keywords: [
    'faculdade ead',
  ...
  openGraph: {
    title: 'Faculdade EAD Mais Barata: Bolsa de até 78% | Bolsa Click',
    description:
      'A faculdade EAD mais barata parte de R$ 99/mês com bolsa de até 78%, reconhecida pelo MEC, nas maiores redes de ensino do país. Inscrição grátis, sem ENEM.',
    url: `${SITE_URL}/faculdade-ead`,
        ...
        <div className="container mx-auto px-4 py-20 md:py-28 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-[64px] font-semibold text-white leading-[1.05] mb-5">
              Faculdade EAD mais barata{' '}
              <span className="italic text-white/85">com bolsa de até 78% de desconto</span>
            </h1>
