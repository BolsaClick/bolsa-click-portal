          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            <div className="lg:col-span-8">
              ...
              <p className="mt-5 text-lg md:text-xl text-ink-700 max-w-3xl leading-relaxed">
                {fromFallback
                  ? `Veja como funciona a ${institution.name} em ${cityName}-${cityState} e como conseguir bolsa de estudo de até 78%.`
                  : `${offers.length} ${offers.length === 1 ? 'curso disponível' : 'cursos disponíveis'} na ${institution.name} em ${cityName}-${cityState}, com bolsa de até 78% pelo Bolsa Click. ${units.length > 0 ? `${units.length} ${units.length === 1 ? 'polo' : 'polos'} físicos identificados.` : 'Cursos presenciais, EAD e semipresenciais.'}`}
              </p>
          ...
          <div className="divide-y divide-hairline border-y border-hairline">
            {[
              ...
              },
              {
                ...
                a: lowPrice > 0
                  ? `As mensalidades começam em R$ ${formatBRL(lowPrice)} com bolsa pelo Bolsa Click, com descontos de até 78%. O valor varia conforme o curso e a modalidade escolhida.`
                  : `As mensalidades variam por curso e modalidade. Pelo Bolsa Click, você consegue bolsa de até 78% em qualquer curso disponível na ${institution.name}.`,
              },
              {
              ...
              },
              {
                ...
                a: `A inscrição é totalmente gratuita pelo Bolsa Click. Escolha o curso, compare as ofertas disponíveis, garanta sua bolsa de até 78% e faça matrícula direto pelo site, sem custo de processo seletivo.`,
              },
            ].map((item, i) => (
