...
export interface AthenaOptions {
  ...
  /**
   * Flags de consentimento (nomes confirmados na spec do Tech Lead Backend,
   * 2026-07-23 — athena-api já repassa pro payload YDUQS). Opcionais, não
   * bloqueiam a inscrição.
   */
