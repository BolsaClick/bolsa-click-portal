...
export const themes = {
  bolsaclick: {
    ...
    description: 'Bolsa Click é a plataforma de bolsas de estudo com até 78% de desconto nas maiores redes de ensino do Brasil. Graduação, pós, técnicos e EAD. Cadastre-se grátis!',
    favicon: '/favicon.ico',
  ...
  anhanguera: {
    ...
    description: 'O Bolsa Click tem Bolsas de Estudo de até 78% nas maiores redes de ensino do Brasil, com polos em mais de 280 cidades. Graduação e pós, técnicos, idiomas',
