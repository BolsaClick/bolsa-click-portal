...
const institutions = [
  {
    ...
    description: 'A Anhanguera é uma das maiores instituições de ensino superior do Brasil, pertencente ao grupo Cogna Educação. Com mais de 70 polos de ensino presencial e EAD espalhados pelo país, oferece cursos de graduação, pós-graduação e extensão com mensalidades acessíveis e bolsas de estudo próprias.',
...
Entre os principais diferenciais da Anhanguera estão: mensalidades acessíveis, bolsas de estudo próprias, ampla rede de polos presenciais e EAD, canal de empregabilidade exclusivo para alunos, e diploma reconhecido pelo MEC em todo o território nacional.`,
    founded: 1994,
    ...
    highlights: [
      ...
      'Bolsas de estudo próprias, sem ENEM',
    ...
    metaTitle: 'Faculdade Anhanguera - Bolsas de Estudo | Bolsa Click',
    metaDescription: 'Encontre bolsas de estudo na faculdade Anhanguera. Cursos de graduação, pós-graduação e EAD. Mais de 70 polos em todo o Brasil. Inscreva-se grátis!',
    isActive: true,
    order: 1,
  },
  {
...
Os principais diferenciais da Unopar são: liderança em EAD no Brasil, 750+ polos presenciais para suporte ao aluno, mensalidades acessíveis, tutoria personalizada, material didático digital incluso, e flexibilidade de horários para quem trabalha.`,
    ...
    highlights: [
      ...
      'Mensalidades acessíveis e bolsas de estudo próprias',
...
Entre os diferenciais da Faculdade Pitágoras estão: tradição de mais de 50 anos em educação, ampla rede de unidades em Minas Gerais e no Nordeste, polos EAD em centenas de cidades, mensalidades acessíveis com bolsas de estudo próprias, e diploma reconhecido pelo MEC em todo o território nacional.`,
    founded: 1966,
    type: 'PRIVADA' as const,
    campusCount: null,
    studentCount: null,
    ...
    metaTitle: 'Faculdade Pitágoras - Bolsas de Estudo | Bolsa Click',
    metaDescription: 'Encontre bolsas de estudo na Faculdade Pitágoras. Tradição de mais de 50 anos, polos em MG e no Nordeste. EAD e presencial. Inscreva-se grátis!',
    isActive: true,
    order: 3,
  },
  {
...
Os principais diferenciais da Estácio incluem: mais de 50 anos de tradição em educação, nota 4 no MEC, programas de mestrado e doutorado, ampla rede de campus presenciais e EAD, convênios com empresas para estágio e empregabilidade, biblioteca digital com acervo extenso, e desconto em cursos para alunos e ex-alunos.`,
    ...
    metaTitle: 'Faculdade Estácio - Bolsas de Estudo | Bolsa Click',
...
O cadastro no Bolsa Click é grátis, sem taxa de adesão. A matrícula, as regras e eventuais taxas seguem o contrato da instituição.`,
    ...
    highlights: [
      ...
      'Bolsas de estudo conforme a oferta do catálogo',
    ...
    metaTitle: 'Faculdade Wyden - Bolsas de Estudo | Bolsa Click',
    metaDescription:
      'Bolsas de estudo na Wyden (grupo YDUQS). Graduação EAD e presencial reconhecida pelo MEC. Cadastro grátis, sem taxa de adesão.',
    isActive: true,
    order: 4,
  },
  {
...
Os diferenciais do IBMEC incluem: nota 5 no MEC (nota máxima), corpo docente 100% composto por mestres e doutores, metodologia de ensino baseada em estudos de caso, forte conexão com o mercado financeiro e corporativo, programas de intercâmbio com universidades internacionais, e uma rede de ex-alunos influente nos setores financeiro e empresarial.`,
    ...
    keywords: [
      ...
      'ibmec mba', 'ibmec pós-graduação',
      'ibmec nota mec', 'ibmec mensalidade',
    ],
    metaTitle: 'Faculdade IBMEC - Nota 5 no MEC - Cursos e Mensalidades | Bolsa Click',
    metaDescription: 'Veja os cursos, mensalidades reais e nota MEC da Faculdade IBMEC. Instituição nota 5 no MEC, referência em negócios, direito e engenharia. Campus em SP, RJ, BH e Brasília.',
    isActive: false,
    order: 7,
  },
]
