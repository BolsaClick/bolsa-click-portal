...
const institutions = [
  {
    ...
    description: `A Anhanguera é uma das maiores instituições de ensino superior do Brasil, pertencente ao grupo Cogna Educação. Com mais de 70 polos de ensino presencial e EAD espalhados pelo país, oferece cursos de graduação, pós-graduação e extensão com mensalidades acessíveis e bolsas de estudo de até ${DISCOUNT_CEILING_PCT}%.`,
...
Entre os principais diferenciais da Anhanguera estão: mensalidades acessíveis, bolsas de estudo de até ${DISCOUNT_CEILING_PCT}% de desconto, ampla rede de polos presenciais e EAD, canal de empregabilidade exclusivo para alunos, e diploma reconhecido pelo MEC em todo o território nacional.`,
    founded: 1994,
    ...
    highlights: [
      ...
      `Bolsas de estudo de até ${DISCOUNT_CEILING_PCT}% de desconto`,
    ...
    metaTitle: `Faculdade Anhanguera - Bolsas de Estudo com até ${DISCOUNT_CEILING_PCT}% de Desconto | Bolsa Click`,
    metaDescription: `Encontre bolsas de estudo na faculdade Anhanguera com até ${DISCOUNT_CEILING_PCT}% de desconto. Cursos de graduação, pós-graduação e EAD. Mais de 70 polos em todo o Brasil. Inscreva-se grátis!`,
    isActive: true,
    order: 1,
  },
  {
...
Os principais diferenciais da Unopar são: liderança em EAD no Brasil, 750+ polos presenciais para suporte ao aluno, mensalidades acessíveis, tutoria personalizada, material didático digital incluso, e flexibilidade de horários para quem trabalha.`,
    ...
    highlights: [
      ...
      `Mensalidades acessíveis com bolsas de até ${DISCOUNT_CEILING_PCT}%`,
...
Entre os diferenciais da Faculdade Pitágoras estão: tradição de mais de 50 anos em educação, ampla rede de unidades em Minas Gerais e no Nordeste, polos EAD em centenas de cidades, mensalidades acessíveis com bolsas de estudo de até ${DISCOUNT_CEILING_PCT}% de desconto, e diploma reconhecido pelo MEC em todo o território nacional.`,
    ...
    metaTitle: `Faculdade Pitágoras - Bolsas de Estudo com até ${DISCOUNT_CEILING_PCT}% de Desconto | Bolsa Click`,
    metaDescription: `Encontre bolsas de estudo na Faculdade Pitágoras com até ${DISCOUNT_CEILING_PCT}% de desconto. Tradição de mais de 50 anos, polos em MG e no Nordeste. EAD e presencial. Inscreva-se grátis!`,
    isActive: true,
    order: 3,
  },
  {
...
Os principais diferenciais da Estácio incluem: mais de 50 anos de tradição em educação, nota 4 no MEC, programas de mestrado e doutorado, ampla rede de campus presenciais e EAD, convênios com empresas para estágio e empregabilidade, biblioteca digital com acervo extenso, e desconto em cursos para alunos e ex-alunos.`,
    ...
    metaTitle: `Faculdade Estácio - Bolsas de Estudo com até ${DISCOUNT_CEILING_PCT}% de Desconto | Bolsa Click`,
