...
const excerpt =
  `A faculdade EAD mais barata combina mensalidade já menor que a presencial com bolsa própria de até ${DISCOUNT_CEILING_PCT}%. Veja os cursos mais em conta, faixas de preço reais e como conferir o MEC antes de matricular.`
const keywords = [
...
<ul>
<li><strong>Bolsa própria da faculdade parceira:</strong> desconto aplicado direto na mensalidade, que pode chegar a ${DISCOUNT_CEILING_PCT}% em cursos EAD, sem precisar de nota de corte do ENEM.</li>
...
<ul>
<li><strong>EAD:</strong> mensalidade base menor + bolsa própria de até ${DISCOUNT_CEILING_PCT}%, chegando a valores a partir de R$ 108,39 por mês.</li>
