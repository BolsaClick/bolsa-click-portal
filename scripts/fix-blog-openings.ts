...
const FIXES: Fix[] = [
  {
    ...
    newFirstPHtml: `<p>Pra conseguir bolsa de 50% ou mais em faculdade particular, os 4 caminhos com maior chance são: <strong>Prouni</strong> (bolsa integral ou parcial via ENEM ≥ 450 + renda baixa), <strong>Fies</strong> (financiamento estudantil pago após formado), <strong>bolsas próprias das faculdades parceiras</strong> (até 78% de desconto, sem ENEM e sem comprovação de renda) e <strong>marketplaces agregadores de bolsa</strong>. Cada um tem critério diferente — veja como funciona abaixo.</p>`,
  },
  {
