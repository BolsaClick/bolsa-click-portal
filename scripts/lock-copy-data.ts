...
export const GUIA_PASSO_A_PASSO = {
  slug: GUIA_PASSO_A_PASSO_SLUG,
  ...
  keywords: [
    ...
    'bolsa sem enem',
    'bolsa própria faculdade',
    'prouni 2026',
    'fies 2026',
  ],
  tags: ['Bolsas', 'ProUni', 'FIES', '2026'],
  imageAlt: 'Estudante comparando bolsas de estudo de faculdades parceiras no Bolsa Click',
...
<h3>Caminho 1: ProUni (programa do MEC)</h3>
<p>O ProUni oferece bolsa de 50% ou 100% em faculdades particulares conveniadas. Exige ENEM (nota mínima de 450 pontos, sem zerar a redação) e comprovação de renda familiar. As inscrições abrem duas vezes por ano, no portal oficial do MEC. A bolsa federal cobre a mensalidade enquanto você mantém os requisitos do programa.</p>
<ul>
  <li><strong>Onde inscrever:</strong> <a href="https://acessounico.mec.gov.br/prouni" rel="nofollow noopener" target="_blank">acessounico.mec.gov.br/prouni</a></li>
  <li><strong>Quando:</strong> edições no primeiro e no segundo semestre</li>
  <li><strong>Guia no Bolsa Click:</strong> <a href="/prouni">como funciona o ProUni</a></li>
</ul>

<h3>Caminho 2: FIES (financiamento estudantil)</h3>
...
<ol>
  ...
  <li>Compare o valor cheio e o valor com bolsa.</li>
  <li>Cadastre-se grátis e siga para a matrícula com a instituição.</li>
</ol>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Sim (edital)</td>
      <td>Sim (edital)</td>
      <td>Não na plataforma</td>
    </tr>
  </tbody>
</table>

<h2>Documentos</h2>
<p>ProUni e FIES pedem documentos do edital (identidade, CPF, renda, ENEM). Para bolsa própria, o cadastro no Bolsa Click é grátis; a faculdade pode pedir RG, CPF, comprovante de endereço e histórico do ensino médio na matrícula. Confira a lista da oferta escolhida.</p>
...
<p>ProUni e FIES seguem o calendário do MEC. Na bolsa própria, o vestibular online das parceiras costuma devolver resultado em poucos dias úteis — o prazo exato é da instituição, não um relógio de matrícula da plataforma.</p>

<p>Compare as ofertas em <a href="/">Bolsa Click</a> ou no <a href="/sem-enem">guia de faculdade sem ENEM</a>.</p>
`.trim(),
}

/** Payload de Institution.wyden — manter alinhado a prisma/seed-institutions.ts */
export const WYDEN_INSTITUTION = {
  slug: 'wyden',
  name: 'Wyden',
  shortName: 'WYDEN',
  fullName: 'Wyden',
  ...
  longDescription: `A Wyden é a marca de centros universitários do grupo YDUQS, um dos maiores grupos de educação superior do Brasil (o mesmo grupo da Estácio). No catálogo do Bolsa Click a rede aparece com ofertas de graduação EAD e presencial.
...
O cadastro no Bolsa Click é grátis, sem taxa de adesão. A matrícula, as regras e eventuais taxas seguem o contrato da instituição.`,
  ...
  campusCount: null as number | null,
  studentCount: null as string | null,
  coursesOffered: null as number | null,
  headquartersCity: null as string | null,
  headquartersState: null as string | null,
  mecRating: null as number | null,
